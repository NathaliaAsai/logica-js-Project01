...
// Se quiséssemos alterar para 1 a 1.000 ou 1 a qualquer número que você imaginar, precisávamos mudar a linha 2, onde 
//temos let numerosecreto.
...
let numeroMaximo = prompt(`Digite um numero máximo`);
