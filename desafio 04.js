...
//02 - Crie uma variável chamada "nome" e atribua a ela o seu nome. Em seguida, utilize o console.log para exibir 
...
console.log(`O sua linguagem de programação favorita é ${name}`);
...
console.log(`A soma de ${valor1} mais ${valor2} é igual a ${resultado}.`);
...
//07 - Peça ao usuário para inserir sua idade com prompt. Com base na idade inserida, 
...
let numeroInteiro = parseInt(Math.random () *10) + 1; //x10 para transformar em dezena e +1 para transforama 0~9 em 1~10
console.log(numeroInteiro);

//13 - Use o Math.random para gerar um número inteiro entre 1 e 1000 e exiba esse número no console.
let numeroInteiroRandomico = ParseInt(Math.random () * 1000) +1;
console.log(numeroInteiro);
